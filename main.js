...
await axios.post(`https://crudcrud.com/api/7f318b2ddffa49acb69123b791885c8f/dishdata`, { dishdata })
  .then((res) => {
  ...
  axios.get(`https://crudcrud.com/api/7f318b2ddffa49acb69123b791885c8f/dishdata`)
  .then((res) => { 
...
//remove from server 
axios
.delete(`https://crudcrud.com/api/7f318b2ddffa49acb69123b791885c8f/dishdata/${btnId}`)
...
.get(`https://crudcrud.com/api/7f318b2ddffa49acb69123b791885c8f/dishdata`)
.then((res) => { 
